export default function Footer() {
  return (
    <footer class="footer footer-center p-4 bg-neutral text-neutral-content fixed bottom-0">
      <div class="grid-flow-col gap-4">
        <a href="https://github.com/Aerodlyn">
        ...
        <a href="https://linkedin.com/in/patrick-jahnig">
        ...
        <a href="mailto:patrick@aerodlyn.io">
